                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control" onkeyup="Mayus(this);" id="contact" name="contact"
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control" onkeyup="Mayus(this);" id="phone" name="phone"
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control" onkeyup="Mayus(this);" id="address" name="address"
