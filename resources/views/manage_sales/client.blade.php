    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="card-title text-primary">Lista de Clientes</h2>
                    </div>
                ...
                <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control" onkeyup="Mayus(thisss);" id="contact" name="contact" placeholder="Contacto"
                                    required>
                                <div class="invalid-feedback">
                                    Dato necesario.
                                </div>
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control" onkeyup="Mayus(thisss);" id="nit" name="nit" placeholder="Nit"
                                    required>
                                <div class="invalid-feedback">
                                    Dato necesario.
                                </div>
...
@endsection
@section('scripts')
<script src="{{ URL::asset('js/scripts/client.js') }}"></script>
@endsection